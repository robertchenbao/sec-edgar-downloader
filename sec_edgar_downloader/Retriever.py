...
class Retriever:
    ...
    Usage::
        ...
        >>> from sec_edgar_downloader import Retriever
        >>> retrieve = Retriever()
    """
    ...
    def get(
        ...
        Usage::
            ...
            >>> retrieve.get("8-K", "AAPL")

            # Get all 8-K filings for Apple, including filing amends (8-K/A)
            >>> retrieve.get("8-K", "AAPL", include_amends=True)

            # Get all 8-K filings for Apple after January 1, 2017 and before March 25, 2017
            >>> retrieve.get("8-K", "AAPL", after_date="20170101", before_date="20170325")

            # Get the five most recent 10-K filings for Apple
            >>> retrieve.get("10-K", "AAPL", 5)

            # Get all 10-Q filings for Visa
            >>> retrieve.get("10-Q", "V")

            # Get all 13F-NT filings for the Vanguard Group
            >>> retrieve.get("13F-NT", "0000102909")

            # Get all 13F-HR filings for the Vanguard Group
            >>> retrieve.get("13F-HR", "0000102909")

            # Get all SC 13G filings for Apple
            >>> retrieve.get("SC 13G", "AAPL")

            # Get all SD filings for Apple
            >>> retrieve.get("SD", "AAPL")
        """
        ...
        for filing in filings_to_fetch:
            ...
            list_of_filings.append(resp.text)
            time.sleep(0.15)
